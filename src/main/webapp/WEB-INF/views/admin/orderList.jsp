			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.chenwenfeng.model.Order o=(com.chenwenfeng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("conn");
							com.chenwenfeng.dao.UserDao userDao=new com.chenwenfeng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.chenwenfeng.model.Payment.findByPaymentId(con,n);
							 %>
